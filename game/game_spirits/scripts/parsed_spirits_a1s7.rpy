label spirits_a1s7:
    ...
    voice "C-8-17.mp3" #Caelum (Daniel Acosta)
    cae "Alex!"

    voice "C-8-18.mp3" #Alex (Bonnie Mitchel)
    alx "LET ME OUT!"

    voice "C-8-19.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-8-22.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-8-23.mp3" #Caelum (Daniel Acosta)
    cae "...You okay?"
    ...
    voice "C-8-24.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-8-25.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-8-26.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-8-27.mp3" #Caelum (Daniel Acosta)
    cae "Do you… I mean, I’ll listen, if you wanna talk about it."

    voice "C-8-28.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-8-36.mp3" #Alex (Bonnie Mitchel)
    alx "Caelum..."
...
label CaelumIsDead:
    ...
    voice "C-8-40.mp3" #Caelum (Daniel Acosta)
    cae "Uh, if you ever want to get therapy, the counselors here are pretty chill? Way better than the administration, I promise."

    voice "C-8-41.mp3" #Alex (Bonnie Mitchel)
    alx "Oh, I’ve got an appointment scheduled, actually. With a Marilyn."

    voice "C-8-42.mp3" #Caelum (Daniel Acosta)
    cae "Cool."

    voice "C-8-43.mp3" #Caelum (Daniel Acosta)
    cae "Uh, so are you okay?"

    voice "C-8-44.mp3" #Alex (Bonnie Mitchel)
    alx "Fine. Really."

    voice "C-8-45.mp3" #Caelum (Daniel Acosta)
    cae "Okay. Well, remember, I’m here."

    voice "C-8-46.mp3" #Caelum (Daniel Acosta)
    cae "See you in the morning, then?"

    voice "C-8-47.mp3" #Alex (Bonnie Mitchel)
    alx "Yeah! Good night, Caelum."

    voice "C-8-48.mp3" #Caelum (Daniel Acosta)
    cae "Night."
...
label BuddingRelationship:
    ...
    voice "C-8-49.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-8-52.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-8-60.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-8-61.mp3" #Caelum (Daniel Acosta)
    cae "I’m… not sure I understand."

    voice "C-8-62.mp3" #Alex (Bonnie Mitchel)
    alx "I’ll put it this way, then."

    voice "C-8-63.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-8-69.mp3" #Alex (Bonnie Mitchel)
    alx "I know it sounds crazy! But--"

    voice "C-8-70.mp3" #Caelum (Daniel Acosta)
    cae "Are there ghosts in this house?"

    voice "C-8-71.mp3" #Alex (Bonnie Mitchel)
    alx "…"
    ...
    voice "C-8-79.mp3" #Alex (Bonnie Mitchel)
    alx "I--"

    voice "C-8-80.mp3" #Alex (Bonnie Mitchel)
    alx "Wait, are you saying that you believe me?"

    voice "C-8-81.mp3" #Caelum (Daniel Acosta)
    cae "I… think so, yeah."

    voice "C-8-82.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-8-83.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-8-84.mp3" #Alex (Bonnie Mitchel)
    alx "Oh thank god."
    ...
    voice "C-8-86.mp3" #Alex (Bonnie Mitchel)
    alx "Thank you. Thankyouthankyouthankyou!"

    voice "C-8-87.mp3" #Alex (Bonnie Mitchel)
    alx "Nobody’s ever believed me before…"

    voice "C-8-88.mp3" #Caelum (Daniel Acosta)
    cae "Hey. It’s alright."

    voice "C-8-89.mp3" #Caelum (Daniel Acosta)
