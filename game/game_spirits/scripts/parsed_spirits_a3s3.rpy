...
label spirits_a3s3:
    ...
    alx "Oh, there you are."

    voice "C-18-2.mp3" #Genevieve (Lasli Tran and Other)
    alx "God, that’s disorienting."
    ...
    alx "Alexandra, look down at yourself."
    ...
    alx "Before long, you’ll become like me. Like I was."
    ...
    alx "Your memories will go first. Your… {i}self{/i} will go next. You will erode. Your ego is dying."
    ...
    alx "What’s so wrong with that?"

    voice "C-18-29.mp3" #Alex (Bonnie Mitchel)
    alx2 "So what, you're just going to run away with my body? Act as if there's no problem with that?"
    ...
    alx "I don’t forgive you for ignoring me, but I think I understand why you did. And now… now I can’t ever forget."
