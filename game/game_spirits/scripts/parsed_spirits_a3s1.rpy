...
label spirits_a3s1:
    ...
    voice "C-16-1.mp3" #Caelum (Daniel Acosta)
    cae "Hey, you need a hand?"

    show cae neutral1 at right with dissolve
    ...
    voice "C-16-2.mp3" #Alex (Bonnie Mitchel)
    alx "Caelum!"

    voice "C-16-3.mp3" #Caelum (Daniel Acosta)
    cae "’Sup, Alex?"

    voice "C-16-4.mp3" #Alex (Bonnie Mitchel)
    alx "You didn’t text me that you were picking up your stuff!"

    show cae happy1 with dissolve

    voice "C-16-5.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-16-6.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-16-23.mp3" #Alex (Bonnie Mitchel)
    ...
    voice "C-16-32.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-16-33.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-16-34.mp3" #Alex (Bonnie Mitchel)
    alx "W-Wait."

    voice "C-16-35.mp3" #Alex (Bonnie Mitchel)
    alx "Are you… I mean, you’re, like-- I mean, what you’re saying is…"

    voice "C-16-36.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-16-37.mp3" #Alex (Bonnie Mitchel)
    alx "YesI’dloveto!"

    voice "C-16-38.mp3" #Caelum (Daniel Acosta)
    cae "Sweet. I mean, cause of the ice cream and cause of the--"

    show alx happy1 blush with dissolve

    voice "C-16-39.mp3" #Alex (Bonnie Mitchel)
    alx "Date, yeah."

    show cae happy1 blush with dissolve

    voice "C-16-40.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-16-41.mp3" #Alex (Bonnie Mitchel)
    alx "Oh I know, right? I have an essay due in a week, ten pages, with three empirical articles as sources."

    show cae angry1 with dissolve

    voice "C-16-42.mp3" #Caelum (Daniel Acosta)
    cae "We just found dozens of {i}dead bodies{/i} on campus. In our dorm. That isn’t worth a few days off?"

    voice "C-16-43.mp3" #Alex (Bonnie Mitchel)
    alx "Apparently not."

    show alx neutral1 blush with dissolve
    show cae neutral1 blush with dissolve

    voice "C-16-44.mp3" #Alex (Bonnie Mitchel)
    alx "..."

    voice "C-16-45.mp3" #Caelum (Daniel Acosta)
    cae "So, you better get--"

    voice "C-16-46.mp3" #Alex (Bonnie Mitchel)
    alx "Yeah, I really ought to get going."

    voice "C-16-47.mp3" #Caelum (Daniel Acosta)
    ...
    voice "C-16-48.mp3" #Alex (Bonnie Mitchel)
    alx "No, I’m okay. Thank you, though."

    show cae happy1 with dissolve

    voice "C-16-49.mp3" #Caelum (Daniel Acosta)
    cae "Alright. See you in class?"

    voice "C-16-50.mp3" #Alex (Bonnie Mitchel)
    alx "Yep."
    ...
    voice "C-16-51.mp3" #Caelum (Daniel Acosta)
    cae "Text me if you need help with homework, okay?"

    voice "C-16-52.mp3" #Alex (Bonnie Mitchel)
    alx "Yeah."

    voice "C-16-53.mp3" #Caelum (Daniel Acosta)
    cae "Hey, Alex. Look at me."

    show cae happy1 with dissolve

    voice "C-16-54.mp3" #Caelum (Daniel Acosta)
