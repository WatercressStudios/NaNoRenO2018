label letgo_103:
    ...
    scene letgo park lake path with dissolve
    ...
    voice "C-103-6.mp3" #Elijah (Michael Potok)
    eli "Of course."

    show eli:
        ease 1.0 align (0.45,1.0)
        ease 1.5 align (0.55,1.0)
    pause 1.0
    show may:
        ease 1.5 align (0.35,1.0)

    pause 1.5
    show eli:
        ease 0.4 align (0.6,1.0)
    show may:
        ease 1.5 align (0.25,1.0)
        pause 0.1
        ease 1.5 align (0.35,1.0)
        pause 0.1
        repeat
    ...
    voice "C-103-7.mp3" #Maya (shiena)
    may "You gotta swing with me! Come on!"

    voice "C-103-8.mp3" #Elijah (Michael Potok)
    eli "I’m pretty sure my legs are too long. My feet will scrape the ground."

    voice "C-103-9.mp3" #Maya (shiena)
    may "Well, you gotta try!"

    voice "C-103-10.mp3" #Elijah (Michael Potok)
    ...
    voice "C-103-11.mp3" #Maya (shiena)
    ...
    voice "C-103-12.mp3" #Elijah (Michael Potok)
    ...
    voice "C-103-13.mp3" #Maya (shiena)
    ...
    "The short walk has the sun setting and the brightest stars coming into focus instead."
    ...
    show may sheepish2 with dissolve

    voice "C-103-31.mp3" #Maya (shiena)
