label letgo_501a4:
    ...
    show may adore1 cry with dissolve
    "We stay like this for several minutes. Neither of us want to move..."

    show may:
        ease 0.5 align (0.65,1.0)

    "Eventually, Maya steps back. Her large brown eyes are glistening in the sunset."

    show eli worried1 with dissolve
    voice "C-501a4-4.mp3" #Elijah (Michael Potok)
    eli "May, what’s wrong?"

    show may forcedsmile3 cry with dissolve
    ...
    show may forcedsmile3 with dissolve
    ...
    show may forcedsmile1 close with dissolve
    ...
    show may forcedsmile1 cry with dissolve
    # VA: voice breaking
    ...
    show may happy2 cry with dissolve
    ...
    "Before I can ask her, she releases my hands and takes a step back."
