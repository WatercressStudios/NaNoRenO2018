label letgo_102:
    ...
    voice "C-102-7.mp3" #Elijah (Michael Potok)
    ...
    voice "C-102-10.mp3" #Maya (shiena)
    may "B-Burnt it? Like, how?"

    show eli cool2 close with dissolve

    voice "C-102-11.mp3" #Elijah (Michael Potok)
    ...
    scene letgo townsquare cafe inside with dissolve
    show eli normal2 with dissolve:
        align (0.35,1.0)
    ...
    voice "C-102-22.mp3" #Elijah (Michael Potok)
    ...
    voice "C-102-23.mp3" #Maya (shiena)
    may "I was nine!"

    show eli cool2 with dissolve

    voice "C-102-24.mp3" #Elijah (Michael Potok)
    eli "So was I, and I wasn’t yelling at you!"

    show may cheeky1 close with dissolve

    voice "C-102-25.mp3" #Maya (shiena)
    may "No, you just teared up a little is all."

    show eli angry2 with dissolve

    voice "C-102-26.mp3" #Elijah (Michael Potok)
    ...
    voice "C-102-27.mp3" #Maya (shiena)
    may "Yeah, yeah, okay. Scared of a girl; I see how it is."

    show eli worried2 with dissolve

    voice "C-102-28.mp3" #Elijah (Michael Potok)
    eli "Girls are scary!"

    show may aww2 with dissolve

    voice "C-102-29.mp3" #Maya (shiena)
    may "Is that why you never date?"

    voice "C-102-30.mp3" #Elijah (Michael Potok)
    ...
    voice "C-102-31.mp3" #Maya (shiena)
    may "It’s okay; we both know why you didn’t date anyone."

    "She gives me a wink."

    voice "C-102-32.mp3" #Maya (shiena)
    ...
    voice "C-102-33.mp3" #Elijah (Michael Potok)
    eli "But we just got here… Huh?"

    show eli worried1 close with dissolve
    ...
    show eli angry1 close with dissolve
    ...
    voice "C-102-43.mp3" #Elijah (Michael Potok)
    eli "So how has work been? Was it hard for you to get time off?"

    show may happy2 with dissolve

    voice "C-102-44.mp3" #Maya (shiena)
    ...
    voice "C-102-48.mp3" #Elijah (Michael Potok)
    eli "Are you warm? Did you want me to get us some water or something?"

    show may nervous2 close with dissolve

    voice "C-102-49.mp3" #Maya (shiena)
