label flood_403:
    ...
    show oli cheerful smile with dissolve:
        align (0.65, 1.0)
    voice "game_flood/voice/C-403-1.ogg" #Oliver (Matt Armstrong)
    oli "Welcome back, missy."

    show oph weirdedout with dissolve:
        align (0.35, 1.0)
    voice "game_flood/voice/C-403-2.ogg" #Ophelia (Cospcaptor)
    oph "Why the hell are you standing around out here? It's still drizzling."

    show oli cheerful smile close
    voice "game_flood/voice/C-403-3.ogg" #Oliver (Matt Armstrong)
    oli "I decided to make room inside."

    show oph irritated close
    voice "game_flood/voice/C-403-4.ogg" #Ophelia (Cospcaptor)
    oph "English, please."

    show oli serious 
    voice "game_flood/voice/C-403-5.ogg" #Oliver (Matt Armstrong)
    oli "Some kids barged in and started yapping about rehearsing. Apparently they didn't have anywhere else to go."

    show oph surprised
    voice "game_flood/voice/C-403-6.ogg" #Ophelia (Cospcaptor)
    oph "Music at this time in the morning?"

    show oli serious close
    voice "game_flood/voice/C-403-7.ogg" #Oliver (Matt Armstrong)
    oli "I don't pretend to understand it either..."

    show oph tiredsmile
    voice "game_flood/voice/C-403-8.ogg" #Ophelia (Cospcaptor)
    oph "Burg?"

    show oli smile  
    voice "game_flood/voice/C-403-9.ogg" #Oliver (Matt Armstrong)
    oli "Please."

    show oph neutral
    voice "game_flood/voice/C-403-10.ogg" #Ophelia (Cospcaptor)
    oph "At least that's breakfast out of the way."

    show oli cheerful grin close
    voice "game_flood/voice/C-403-11.ogg" #Oliver (Matt Armstrong)
    oli "Nothing beats a warm meal on the cold night."

    show oli cheerful grin
    voice "game_flood/voice/C-403-12.ogg" #Oliver (Matt Armstrong)
    oli "You know, I've been coming here for years and I've never been able to go in during the day."
    
    voice "game_flood/voice/C-403-13.ogg" #Ophelia (Cospcaptor)
    oph "How's that? I mean, security is pretty lax."

    show oli serious  
    voice "game_flood/voice/C-403-14.ogg" #Oliver (Matt Armstrong)
    oli "I'm always busy. Family to feed, friends to accompany."

    show oli serious close
    voice "game_flood/voice/C-403-15.ogg" #Oliver (Matt Armstrong)
    ...
    show oph defensive
    voice "game_flood/voice/C-403-16.ogg" #Ophelia (Cospcaptor)
    oph "Not to be rude, but they don't sound all that grateful."

    show oli serious
    voice "game_flood/voice/C-403-17.ogg" #Oliver (Matt Armstrong)
    ...
    show oli smile 
    voice "game_flood/voice/C-403-18.ogg" #Oliver (Matt Armstrong)
    oli "They're preparing for the rest of their lives. I couldn't be happier about that."

    show oli smile close
    voice "game_flood/voice/C-403-19.ogg" #Oliver (Matt Armstrong)
    oli "But it really wouldn't hurt to spend one weekend with dear old dad every once in awhile."

    show oph neutral
    voice "game_flood/voice/C-403-20.ogg" #Ophelia (Cospcaptor)
    oph "What about the rest of the family? Surely your wife-"

    show oph defensive close
    voice "game_flood/voice/C-403-21.ogg" #Ophelia (Cospcaptor)
    oph "...oh."

    show oli cheerful grin
    voice "game_flood/voice/C-403-22.ogg" #Oliver (Matt Armstrong)
    oli "Things starting to click?"

    show oph tiredsmile close
    voice "game_flood/voice/C-403-23.ogg" #Ophelia (Cospcaptor)
    oph "Gears are turning, albeit slowly."

    show oli serious  
    voice "game_flood/voice/C-403-24.ogg" #Oliver (Matt Armstrong)
    ...
    show oph defensive
    show oli serious close
    voice "game_flood/voice/C-403-25.ogg" #Oliver (Matt Armstrong)
    ...
    show oli smile close
    voice "game_flood/voice/C-403-26.ogg" #Oliver (Matt Armstrong)
    oli "I don't blame em either. She was a wonderful woman and a better mother."

    show oli serious
    voice "game_flood/voice/C-403-27.ogg" #Oliver (Matt Armstrong)
    oli "A little while after she passed, the opera house ran out of money and shut down. Happened almost overnight."

    voice "game_flood/voice/C-403-28.ogg" #Ophelia (Cospcaptor)
    oph "That's harsh, Oli."

    show oli smile 
    voice "game_flood/voice/C-403-29.ogg" #Oliver (Matt Armstrong)
    ...
    show oli smile close
    voice "game_flood/voice/C-403-30.ogg" #Oliver (Matt Armstrong)
    ...
    show oph surprised
    voice "game_flood/voice/C-403-31.ogg" #Ophelia (Cospcaptor)
    oph "Workers? I thought you said the place went under."

    show oli smile
    voice "game_flood/voice/C-403-32.ogg" #Oliver (Matt Armstrong)
    ...
    show oli serious 
    show oph neutral
    voice "game_flood/voice/C-403-33.ogg" #Oliver (Matt Armstrong)
    oli "By this time next week they'll lay the foundation for a brand new department store."

    show oph scared
    voice "game_flood/voice/C-403-34.ogg" #Ophelia (Cospcaptor)
    oph "You're kidding me!?"

    show oph irritated
    voice "game_flood/voice/C-403-35.ogg" #Ophelia (Cospcaptor)
    oph "Damn businessmen ruining everything!"

    show oli serious  close
    voice "game_flood/voice/C-403-36.ogg" #Oliver (Matt Armstrong)
    oli "I've come to terms with it, Ophelia. Kickin' an screamin' won't do a thing to honor my wife's memory."

    show oph defensive
    voice "game_flood/voice/C-403-37.ogg" #Oliver (Matt Armstrong)
    oli "While I'm not all that happy about it, I figure I've had more than my fair share of time holding on."

    show oli serious 
    voice "game_flood/voice/C-403-38.ogg" #Ophelia (Cospcaptor)
    oph "But-"

    voice "game_flood/voice/C-403-39.ogg" #Oliver (Matt Armstrong)
    oli "No buts."

    voice "game_flood/voice/C-403-40.ogg" #Oliver (Matt Armstrong)
    oli "No 'if's or 'and's either."

    show oph defensive close
    voice "game_flood/voice/C-403-41.ogg" #Ophelia (Cospcaptor)
    oph "...I still don't get it."

    show oli serious close
    voice "game_flood/voice/C-403-42.ogg" #Oliver (Matt Armstrong)
    oli "There's nothing to get. Mourning is over. It's time to move on."

    show oph defensive
    voice "game_flood/voice/C-403-43.ogg" #Ophelia (Cospcaptor)
    oph "I don't know what to say, Oliver. I'm sorry?"

    show oli smile 
    voice "game_flood/voice/C-403-44.ogg" #Oliver (Matt Armstrong)
    oli "Hah, appreciated but unnecessary. If anything I should be thanking you."

    show oph neutral
    show oli cheerful grin
    voice "game_flood/voice/C-403-45.ogg" #Oliver (Matt Armstrong)
    oli "You remind me a lot of her, cliché as it sounds. I never imagined I'd meet someone as amazing as her, and now as a relic of our past is slated for destruction, I meet someone else just as quirky."

    show oph tiredsmile
    voice "game_flood/voice/C-403-46.ogg" #Ophelia (Cospcaptor)
    oph "I'm not quirky... in fact, I'm downright sullen."

    "Oliver just smiles, taking in the moment and enjoying himself."

    voice "game_flood/voice/C-403-47.ogg" #Oliver (Matt Armstrong)
    oli "...A lot like her."

    show oli smile 
    voice "game_flood/voice/C-403-48.ogg" #Oliver (Matt Armstrong)
    ...
    voice "game_flood/voice/C-403-49.ogg" #Ophelia (Cospcaptor)
    oph "Thanks, I guess."

    show oli smile noflower close
    show oph smile close
    voice "game_flood/voice/C-403-50.ogg" #Ophelia (Cospcaptor)
    oph "I mean, it won't fix the hole in my wallet, don't get me wrong."

    show oli smile noflower
    voice "game_flood/voice/C-403-51.ogg" #Oliver (Matt Armstrong)
    oli "It's been a pleasure meeting you, Ophelia, but this old man is far past his bed time."

    voice "game_flood/voice/C-403-52.ogg" #Oliver (Matt Armstrong)
    ...
    show oph smile 
    voice "game_flood/voice/C-403-53.ogg" #Ophelia (Cospcaptor)
