label flood_403:
    ...
    show oph defensive
    voice "C-403-16.mp3" #Ophelia (Cospcaptor)
    oph "Not to be rude, but they don't sound all that grateful."

    show oli serious
    voice "C-403-17.mp3" #Oliver (Matt Armstrong)
    ...
    show oph defensive
    show oli serious close
    voice "C-403-25.mp3" #Oliver (Matt Armstrong)
    ...
    show oli smile close
    voice "C-403-30.mp3" #Oliver (Matt Armstrong)
    ...
    show oph surprised
    voice "C-403-31.mp3" #Ophelia (Cospcaptor)
    oph "Workers? I thought you said the place went under."

    show oli smile
    voice "C-403-32.mp3" #Oliver (Matt Armstrong)
    ...
    show oph tiredsmile
    voice "C-403-46.mp3" #Ophelia (Cospcaptor)
    oph "I'm not quirky... in fact, I'm downright sullen."

    "Oliver just smiles, taking in the moment and enjoying himself."

    voice "C-403-47.mp3" #Oliver (Matt Armstrong)
    oli "...A lot like her."

    show oli smile 
    voice "C-403-48.mp3" #Oliver (Matt Armstrong)
