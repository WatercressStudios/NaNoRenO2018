label flood_202:
    ...
    show oph neutral
    voice "C-202-1.mp3" #Ophelia (Cospcaptor)
    oph "So why are you out here, anyway?"

    show hop angry
    voice "C-202-2.mp3" #Hope (Dani Chambers)
    ...
    voice "C-202-3.mp3" #Hope (Dani Chambers)
    hop "You don't need to stick around. I can look after myself."

    voice "C-202-4.mp3" #Hope (Dani Chambers)
    hop "I'm practically an adult, you know…"

    show oph defensive
    voice "C-202-5.mp3" #Ophelia (Cospcaptor)
    oph "How old are you?"

    show hop neutral
    voice "C-202-6.mp3" #Hope (Dani Chambers)
    hop "Ten."
    ...
    voice "C-202-7.mp3" #Hope (Dani Chambers)
    hop "Agh, Kitty!"
    ...
    voice "C-202-8.mp3" #Hope (Dani Chambers)
    hop "I used to come here with my family all the time."

    voice "C-202-9.mp3" #Hope (Dani Chambers)
    ...
    show hop happy
    voice "C-202-15.mp3" #Hope (Dani Chambers)
    hop "See!"

    "She says just a bit too proudly."

    voice "C-202-16.mp3" #Hope (Dani Chambers)
    ...
    voice "C-202-17.mp3" #Hope (Dani Chambers)
    ...
    show oph tiredsmile
    voice "C-202-18.mp3" #Ophelia (Cospcaptor)
    ...
    show oph surprised
    voice "C-202-19.mp3" #Ophelia (Cospcaptor)
    oph "Wow."
    ...
    show hop neutral
    voice "C-202-20.mp3" #Hope (Dani Chambers)
    ...
    show hop happy
    voice "C-202-21.mp3" #Hope (Dani Chambers)
    hop "The kitty lives just fine in the park."

    show oph smile close
    voice "C-202-22.mp3" #Ophelia (Cospcaptor)
    ...
    show oph neutral
    voice "C-202-23.mp3" #Ophelia (Cospcaptor)
    oph "Hope, can I ask you something?"

    show hop neutral
    voice "C-202-24.mp3" #Hope (Dani Chambers)
    hop "Hmm, what?"

    voice "C-202-25.mp3" #Ophelia (Cospcaptor)
    ...
    show hop hurt downtrodden close
    voice "C-202-35.mp3" #Hope (Dani Chambers)
    hop "And I think maybe it would be better…"
    voice "C-202-36.mp3" #Hope (Dani Chambers)
    ...
    show oph defensive
    voice "C-202-37.mp3" #Ophelia (Cospcaptor)
    ...
    show hop angry
    voice "C-202-38.mp3" #Hope (Dani Chambers)
    hop "I told you I can handle myself!"

    show hop hurt embarrassed 
    voice "C-202-39.mp3" #Hope (Dani Chambers)
    ...
    voice "C-202-50.mp3" #Hope (Dani Chambers)
    hop "Kitty!"

    voice "C-202-51.mp3" #Ophelia (Cospcaptor)
    ...
    show oph neutral close
    voice "C-202-52.mp3" #Ophelia (Cospcaptor)
    ...
    voice "C-202-53.mp3" #Ophelia (Cospcaptor)
    ...
    voice "C-202-54.mp3" #Hope (Dani Chambers)
    ...
    show oph smile
    voice "C-202-55.mp3" #Ophelia (Cospcaptor)
    oph "I guess he went back home."

    show hop happy
    voice "C-202-56.mp3" #Hope (Dani Chambers)
    hop "Yeah… I guess."

    voice "C-202-57.mp3" #Ophelia (Cospcaptor)
    oph "That lady probably lets him out all the time, so he can explore or whatever."

    show oph smile close
    voice "C-202-58.mp3" #Ophelia (Cospcaptor)
    oph "Maybe he got tired of eating your jerky."

    show hop happy close
    voice "C-202-59.mp3" #Hope (Dani Chambers)
    hop "Yeah, maybe."
    ...
    voice "C-202-60.mp3" #Hopes Dad (N/A)
    ...
    show hop happy with easeinright:
        align (0.65, 1.0)
    voice "C-202-81.mp3" #Hope (Dani Chambers)
    hop "Here!"
    ...
    show oph smile with dissolve:
        align (0.35, 1.0)
    voice "C-202-82.mp3" #Ophelia (Cospcaptor)
    oph "Hmm? What's this for?"

    voice "C-202-83.mp3" #Hope (Dani Chambers)
    hop "So you won't get lost."

    show oph smile close
    voice "C-202-84.mp3" #Ophelia (Cospcaptor)
    oph "I see. Thank you."
    ...
    voice "C-202-85.mp3" #Hope (Dani Chambers)
