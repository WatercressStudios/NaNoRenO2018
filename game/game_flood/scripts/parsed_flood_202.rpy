label flood_202:
    ...
    show oph neutral
    voice "game_flood/voice/C-202-1.ogg" #Ophelia (Cospcaptor)
    oph "So why are you out here, anyway?"

    show hop angry
    voice "game_flood/voice/C-202-2.ogg" #Hope (Dani Chambers)
    ...
    voice "game_flood/voice/C-202-3.ogg" #Hope (Dani Chambers)
    hop "You don't need to stick around. I can look after myself."

    voice "game_flood/voice/C-202-4.ogg" #Hope (Dani Chambers)
    hop "I'm practically an adult, you know…"

    show oph defensive
    voice "game_flood/voice/C-202-5.ogg" #Ophelia (Cospcaptor)
    oph "How old are you?"

    show hop neutral
    voice "game_flood/voice/C-202-6.ogg" #Hope (Dani Chambers)
    hop "Ten."
    ...
    voice "game_flood/voice/C-202-7.ogg" #Hope (Dani Chambers)
    hop "Agh, Kitty!"
    ...
    voice "game_flood/voice/C-202-8.ogg" #Hope (Dani Chambers)
    hop "I used to come here with my family all the time."

    voice "game_flood/voice/C-202-9.ogg" #Hope (Dani Chambers)
    ...
    show hop neutral
    voice "game_flood/voice/C-202-12.ogg" #Hope (Dani Chambers)
    hop "The stuff can last for ages, you know."

    show oph weirdedout
    "{i}Just how long does she expect to be out here?{/i}"

    voice "game_flood/voice/C-202-13.ogg" #Hope (Dani Chambers)
    hop "Here, kitty…"

    show oph neutral
    "She holds a piece out in front of her as she approaches the cat."

    voice "game_flood/voice/C-202-14.ogg" #Hope (Dani Chambers)
    ...
    show hop happy
    voice "game_flood/voice/C-202-15.ogg" #Hope (Dani Chambers)
    hop "See!"

    "She says just a bit too proudly."

    voice "game_flood/voice/C-202-16.ogg" #Hope (Dani Chambers)
    ...
    voice "game_flood/voice/C-202-17.ogg" #Hope (Dani Chambers)
    ...
    show oph tiredsmile
    voice "game_flood/voice/C-202-18.ogg" #Ophelia (Cospcaptor)
    ...
    show oph surprised
    voice "game_flood/voice/C-202-19.ogg" #Ophelia (Cospcaptor)
    oph "Wow."
    ...
    show hop neutral
    voice "game_flood/voice/C-202-20.ogg" #Hope (Dani Chambers)
    ...
    show hop happy
    voice "game_flood/voice/C-202-21.ogg" #Hope (Dani Chambers)
    hop "The kitty lives just fine in the park."

    show oph smile close
    voice "game_flood/voice/C-202-22.ogg" #Ophelia (Cospcaptor)
    ...
    show oph neutral
    voice "game_flood/voice/C-202-23.ogg" #Ophelia (Cospcaptor)
    oph "Hope, can I ask you something?"

    show hop neutral
    voice "game_flood/voice/C-202-24.ogg" #Hope (Dani Chambers)
    hop "Hmm, what?"

    voice "game_flood/voice/C-202-25.ogg" #Ophelia (Cospcaptor)
    ...
    voice "game_flood/voice/C-202-26.ogg" #Hope (Dani Chambers)
    hop "It...It's better this way, I think."

    show oph defensive
    voice "game_flood/voice/C-202-27.ogg" #Ophelia (Cospcaptor)
    oph "Is someone hurting you at home?"

    show hop neutral
    voice "game_flood/voice/C-202-28.ogg" #Hope (Dani Chambers)
    hop "Oh no! It's nothing like that."

    show oph neutral
    show hop hurt downtrodden
    voice "game_flood/voice/C-202-29.ogg" #Hope (Dani Chambers)
    hop "It's just that, I think for now… maybe it's better that I take care of myself for now…"

    show hop hurt downtrodden close
    voice "game_flood/voice/C-202-30.ogg" #Hope (Dani Chambers)
    hop "So I'm not such a burden on Mom and Dad."

    show oph defensive
    voice "game_flood/voice/C-202-31.ogg" #Ophelia (Cospcaptor)
    oph "Why do you think you're a burden on them?"

    show hop hurt downtrodden
    voice "game_flood/voice/C-202-32.ogg" #Hope (Dani Chambers)
    hop "Someone at school told me once that children are the most expensive thing that people can have."

    voice "game_flood/voice/C-202-33.ogg" #Hope (Dani Chambers)
    hop "Some of the girls make fun of me, 'cause I have to wear my sister's old clothes."
    voice "game_flood/voice/C-202-34.ogg" #Hope (Dani Chambers)
    ...
    show hop hurt downtrodden close
    voice "game_flood/voice/C-202-35.ogg" #Hope (Dani Chambers)
    hop "And I think maybe it would be better…"
    voice "game_flood/voice/C-202-36.ogg" #Hope (Dani Chambers)
    ...
    show oph defensive
    voice "game_flood/voice/C-202-37.ogg" #Ophelia (Cospcaptor)
    ...
    show hop angry
    voice "game_flood/voice/C-202-38.ogg" #Hope (Dani Chambers)
    hop "I told you I can handle myself!"

    show hop hurt embarrassed 
    voice "game_flood/voice/C-202-39.ogg" #Hope (Dani Chambers)
    hop "I'll think about those things when I need to."

    "It seems she's not going to be that easy to convince."

    show oph irritated closed
    voice "game_flood/voice/C-202-40.ogg" #Ophelia (Cospcaptor)
    oph "Well, I guess since you're staying here in the park, I might as well too."

    show oph tiredsmile
    voice "game_flood/voice/C-202-41.ogg" #Ophelia (Cospcaptor)
    oph "It's not like I've got anywhere to be."

    show hop neutral
    voice "game_flood/voice/C-202-42.ogg" #Hope (Dani Chambers)
    hop "Did you leave home too?"

    show oph neutral close
    voice "game_flood/voice/C-202-43.ogg" #Ophelia (Cospcaptor)
    ...
    voice "game_flood/voice/C-202-44.ogg" #Hope (Dani Chambers)
    hop "A nightmare? What about?"

    show oph defensive
    voice "game_flood/voice/C-202-45.ogg" #Ophelia (Cospcaptor)
    oph "About a flood, I guess."

    voice "game_flood/voice/C-202-46.ogg" #Hope (Dani Chambers)
    hop "A flood?"

    show oph defensive close
    voice "game_flood/voice/C-202-47.ogg" #Ophelia (Cospcaptor)
    oph "My room was full of water. It was rising up to the ceiling. I thought I was going to drown."

    show hop neutral close
    voice "game_flood/voice/C-202-48.ogg" #Hope (Dani Chambers)
    hop "That sounds like a scary dream."

    show oph tiredsmile 
    voice "game_flood/voice/C-202-49.ogg" #Ophelia (Cospcaptor)
    ...
    voice "game_flood/voice/C-202-50.ogg" #Hope (Dani Chambers)
    hop "Kitty!"

    voice "game_flood/voice/C-202-51.ogg" #Ophelia (Cospcaptor)
    oph "Where's he running off to?"

    hide hop with easeoutleft
    ...
    show oph neutral close
    voice "game_flood/voice/C-202-52.ogg" #Ophelia (Cospcaptor)
    ...
    "When I reach the main street, I quickly find Hope."
    show hop hurt downtrodden:
        align (0.7, 1.0)
    "She hadn't gotten very far, and was following the cat down the sidewalk past a row of houses."

    voice "game_flood/voice/C-202-53.ogg" #Ophelia (Cospcaptor)
    oph "Heeey! Don't just run off like that." 

    show oph irritated with easeinleft:
        align (0.4, 1.0)
    ...
    voice "game_flood/voice/C-202-54.ogg" #Hope (Dani Chambers)
    ...
    show oph smile
    voice "game_flood/voice/C-202-55.ogg" #Ophelia (Cospcaptor)
    oph "I guess he went back home."

    show hop happy
    voice "game_flood/voice/C-202-56.ogg" #Hope (Dani Chambers)
    hop "Yeah… I guess."

    voice "game_flood/voice/C-202-57.ogg" #Ophelia (Cospcaptor)
    oph "That lady probably lets him out all the time, so he can explore or whatever."

    show oph smile close
    voice "game_flood/voice/C-202-58.ogg" #Ophelia (Cospcaptor)
    oph "Maybe he got tired of eating your jerky."

    show hop happy close
    voice "game_flood/voice/C-202-59.ogg" #Hope (Dani Chambers)
    hop "Yeah, maybe."
    ...
    voice "game_flood/voice/C-202-60.ogg" #Hopes Dad (N/A)
    vce "Hope! Hope! There you are!"

    show oph neutral
    voice "game_flood/voice/C-202-61.ogg" #Hope (Dani Chambers)
    hop "Dad?!"
    ...
    voice "game_flood/voice/C-202-62.ogg" #Sister (N/A)
    ...
    voice "game_flood/voice/C-202-63.ogg" #Mom (N/A)
    mom "Hope what is that stranger doing with your bags?"

    show oph irritated
    voice "game_flood/voice/C-202-64.ogg" #Dad (N/A)
    dad "Come on now, I've got to be up early tomorrow. Let's go!"

    voice "game_flood/voice/C-202-65.ogg" #Hope (Dani Chambers)
    hop "No...I…"

    show hop hurt downtrodden close
    voice "game_flood/voice/C-202-66.ogg" #Hope (Dani Chambers)
    hop "I don't want to be a burden."

    "She looks as if she's about to burst into tears."

    show oph defensive
    voice "game_flood/voice/C-202-67.ogg" #Ophelia (Cospcaptor)
    oph "Hey…"

    "I say. I put my hand on her shoulder." 

    show oph smile
    voice "game_flood/voice/C-202-68.ogg" #Ophelia (Cospcaptor)
    ...
    show hop happy with easeinright:
        align (0.65, 1.0)
    voice "game_flood/voice/C-202-81.ogg" #Hope (Dani Chambers)
    hop "Here!"
    ...
    show oph smile with dissolve:
        align (0.35, 1.0)
    voice "game_flood/voice/C-202-82.ogg" #Ophelia (Cospcaptor)
    oph "Hmm? What's this for?"

    voice "game_flood/voice/C-202-83.ogg" #Hope (Dani Chambers)
    hop "So you won't get lost."

    show oph smile close
    voice "game_flood/voice/C-202-84.ogg" #Ophelia (Cospcaptor)
    oph "I see. Thank you."
    ...
    voice "game_flood/voice/C-202-85.ogg" #Hope (Dani Chambers)
    hop "I hope you get over your nightmare!"

    show oph tiredsmile close
    voice "game_flood/voice/C-202-86.ogg" #Ophelia (Cospcaptor)
    oph "Yeah kid, me too."
