label flood_402:
    ...
    voice "C-402-3.mp3" #Ophelia (Cospcaptor)
    oph "Y-Y-You AGAIN!?"
    ...
    show oph neutral
    voice "C-402-12.mp3" #Ophelia (Cospcaptor)
    ...
    show oph irritated close
    voice "C-402-21.mp3" #Ophelia (Cospcaptor)
    oph "Which time?"

    show oli serious 
    voice "C-402-22.mp3" #Oliver (Matt Armstrong)
    oli "Hmm?"

    show oph irritated
    voice "C-402-23.mp3" #Ophelia (Cospcaptor)
    oph "Which time are you sorry for; the park or just now?"

    show oli cheerful smile close
    voice "C-402-24.mp3" #Oliver (Matt Armstrong)
    oli "Whichever one got you the worst, I suppose."

    show oli cheerful smile
    voice "C-402-25.mp3" #Oliver (Matt Armstrong)
    oli "That aside, you never answered my question."

    show oph tiredsmile close
    voice "C-402-26.mp3" #Ophelia (Cospcaptor)
    oph "You're going to have to be more specific about that one, bud. You're more than a little talkative..."

    show oli serious 
    voice "C-402-27.mp3" #Oliver (Matt Armstrong)
    ...
    show oli serious 
    voice "C-402-55.mp3" #Oliver (Matt Armstrong)
    oli "I'm rather surprised it lasted as long as it did to be honest with you."

    show oph defensive
    voice "C-402-56.mp3" #Ophelia (Cospcaptor)
    ...
    voice "C-402-57.mp3" #Oliver (Matt Armstrong)
    oli "Of course it does, young lady-"

    show oph neutral close
    voice "C-402-58.mp3" #Ophelia (Cospcaptor)
    oph "Ophelia."

    show oli serious 
    voice "C-402-59.mp3" #Oliver (Matt Armstrong)
    oli "Hmm?"
    
    show oph neutral
    voice "C-402-60.mp3" #Ophelia (Cospcaptor)
    ...
    voice "C-402-61.mp3" #Oliver (Matt Armstrong)
    ...
    show oli cheerful smile close
    voice "C-402-62.mp3" #Oliver (Matt Armstrong)
    ...
    show oli serious close
    voice "C-402-74.mp3" #Oliver (Matt Armstrong)
    oli "So yes, you probably don't understand it yet."

    show oph neutral
    voice "C-402-75.mp3" #Oliver (Matt Armstrong)
    ...
    show oli serious 
    voice "C-402-76.mp3" #Oliver (Matt Armstrong)
    ...
    voice "C-402-82.mp3" #Ophelia (Cospcaptor)
    oph "I figured as much."

    voice "C-402-83.mp3" #Ophelia (Cospcaptor)
    ...
    show oli serious 
    voice "C-402-84.mp3" #Oliver (Matt Armstrong)
    oli "..."

    show oli smile close
    voice "C-402-85.mp3" #Oliver (Matt Armstrong)
    oli "...'Oli'."

    voice "C-402-86.mp3" #Oliver (Matt Armstrong)
