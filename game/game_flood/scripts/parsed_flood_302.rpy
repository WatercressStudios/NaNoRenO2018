label flood_302:
    ...
    voice "game_flood/voice/C-302-1.ogg" #Daisy (Haley C. McCarthy)
    ...
    show oph defensive with dissolve:
        align (0.35, 1.0)
    ...
    "I inhale the dirty smoke and choke a little on it, causing me to let out a series of heavy coughs."
    
    show oph irritated close
    "One step closer to becoming a real adult, I suppose."

    "The girl gestures the box towards Daisy who shakes her head and declines the offer."

    show dai smile close with dissolve:
        align (0.65, 1.0)
    voice "game_flood/voice/C-302-2.ogg" #Daisy (Haley C. McCarthy)
    dai "I don't smoke. Thanks though." 

    "She catches my eye, seeing the cigarette to my mouth."

    show dai neutral
    voice "game_flood/voice/C-302-3.ogg" #Daisy (Haley C. McCarthy)
    ...
    voice "game_flood/voice/C-302-4.ogg" #Daisy (Haley C. McCarthy)
    dai "Do you know what is special about everybody here?"

    #Wolf's part

    show oph tiredsmile
    voice "game_flood/voice/C-302-5.ogg" #Ophelia (Cospcaptor)
    oph "Umm… they all have a story to tell?"

    show dai smile close
    voice "game_flood/voice/C-302-6.ogg" #Daisy (Haley C. McCarthy)
    dai "Well, yes, but that's not everything."

    show oph neutral
    show dai smile
    voice "game_flood/voice/C-302-7.ogg" #Daisy (Haley C. McCarthy)
    ...
    show dai smile
    voice "game_flood/voice/C-302-12.ogg" #Daisy (Haley C. McCarthy)
    dai "They want people who are interested in who they are {i}now{/i}."

    show dai smile 
    voice "game_flood/voice/C-302-13.ogg" #Daisy (Haley C. McCarthy)
    dai "It doesn't matter where you come from. Remember that, Ophelia. I won't pretend to understand just what your situation is, or who you are..."
    
    voice "game_flood/voice/C-302-13B.ogg" #Daisy
    dai "...But it's apparent that you're at a… crossroads, so to speak."

    show dai neutral
    voice "game_flood/voice/C-302-14.ogg" #Daisy (Haley C. McCarthy)
    ...
    voice "game_flood/voice/C-302-15.ogg" #Daisy (Haley C. McCarthy)
    dai "Just be you, and don't be afraid to look at your own flaws, and work on them. Don't be afraid to love yourself, either."

    show dai distant neutral
    voice "game_flood/voice/C-302-16.ogg" #Daisy (Haley C. McCarthy)
    dai "It's just like this little moth friend of yours."

    voice "game_flood/voice/C-302-17.ogg" #Daisy (Haley C. McCarthy)
    ...
    voice "game_flood/voice/C-302-18.ogg" #Daisy (Haley C. McCarthy)
    dai "Anyways, that's enough soapboxing for tonight."

    voice "game_flood/voice/C-302-19.ogg" #Daisy (Haley C. McCarthy)
    dai "Just enjoy yourself a little, okay?"

    show oph smile
    voice "game_flood/voice/C-302-20.ogg" #Ophelia (Cospcaptor)
    oph "...Okay."
    ...
    voice "game_flood/voice/C-302-21.ogg" #Daisy (Haley C. McCarthy)
    dai "Hey, Ophelia, I've gotta head home. I'm taking the bus, you coming with?"

    voice "game_flood/voice/C-302-22.ogg" #Ophelia (Cospcaptor)
    oph "Not yet. I'll walk with you there, but I'm gonna walk around a bit longer."

    voice "game_flood/voice/C-302-23.ogg" #Daisy (Haley C. McCarthy)
    ...
    show dai smile with dissolve:
        align (0.65, 1.0)
    voice "game_flood/voice/C-302-24.ogg" #Daisy (Haley C. McCarthy)
    ...
    voice "game_flood/voice/C-302-25.ogg" #Ophelia (Cospcaptor)
    oph "Yeah, I'll be around too. Probably not around here as much, but I'll find you. Goodnight!"

    show dai confident
    voice "game_flood/voice/C-302-26.ogg" #Daisy (Haley C. McCarthy)
    dai "Oh! And before I leave, I want you to have something."

    show oph surprised
    voice "game_flood/voice/C-302-27.ogg" #Ophelia (Cospcaptor)
    oph "Uh, okay?"
    ...
    show dai smile close
    voice "game_flood/voice/C-302-28.ogg" #Daisy (Haley C. McCarthy)
    dai "I've always found things like this cute. If we never meet again, at least you'll have this!"

    show oph smile
    voice "game_flood/voice/C-302-29.ogg" #Ophelia (Cospcaptor)
